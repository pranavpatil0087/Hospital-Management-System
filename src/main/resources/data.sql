...
VALUES
('Dr. Rakesh Mehta', 'Cardiology', 'rakesh1.mehta@example.com'),
('Dr. Sneha Kapoor', 'Dermatology', 'sneha1.kapoor@example.com'),
('Dr. Arjun Nair', 'Orthopedics', 'arjun1.nair@example.com');